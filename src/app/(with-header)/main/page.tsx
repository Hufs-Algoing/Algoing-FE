  ...
  return (
    <div className="flex flex-col gap-2">
      <div className="bg-gray-100 p-4 rounded-lg flex justify-between items-center">
        <div>
          <p className="text-sm text-gray-600">30251</p>
          <p className="font-medium">루미의 생일파티장 꾸미기</p>
          <p className="text-xs text-gray-400">2025.03.05</p>
        </div>
      </div>
    ...
    <div className="max-w-6xl mx-auto px-6 py-12">
      <div className="flex items-center gap-4 mb-16">
        ...
        <div className="flex-1">
          ...
          <p className="text-sm text-gray-500 mt-1">134 문제 해결</p>
          <Progress value={60} className="mt-2 h-3 bg-gray-200" />
        </div>
        <button className="bg-black text-white px-4 py-2 rounded-lg font-medium">
          성장 그래프
        </button>
        <button className="px-2 py-2 bg-gray-200 rounded-lg text-sm font-medium">
          코드
        </button>
      </div>
        ...
        <div className="flex flex-col gap-6">
          <div className="border rounded-xl p-4">
            ...
            <div className="bg-gray-50 p-4 rounded-lg border text-sm">
              ...
              <div className="text-xs text-gray-400 mt-2">2025.03.25</div>
            </div>
          </div>
          <div className="border rounded-xl p-4">
...
const Progress = ({ value, className = "" }: ProgressProps) => {
  return (
    <div
      className={`relative w-full rounded-full overflow-hidden bg-gray-200 ${className}`}
    >
      <div
        className="h-full bg-purple-400 transition-all duration-300 ease-in-out"
        style={{ width: `${value}%` }}
      />
    </div>
  );
