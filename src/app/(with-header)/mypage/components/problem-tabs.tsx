            ...
            <div className="p-6 overflow-y-auto max-h-[calc(90vh-140px)]">
              <div className="mb-6">
                <h4 className="text-lg font-semibold text-gray-900 mb-2 flex items-center gap-2">
                  <span className="w-6 h-6 flex items-center justify-center rounded-full bg-blue-100 text-blue-700">
                    {getLanguageIcon(selectedProblem.language)}
                  </span>
                  제출한 코드
                </h4>
                <button
                  className="flex items-center gap-1 px-3 py-1 text-xs font-medium rounded-md bg-gray-100 text-gray-700 hover:bg-gray-200 mb-2"
            ...
            <div className="flex items-center justify-between p-4 border-t border-gray-200 bg-gray-50">
              ...
              {selectedProblem.url && (
                <a
                  ...
                  className="flex items-center gap-1 px-4 py-2 text-sm font-medium rounded-md bg-indigo-100 text-indigo-700 hover:bg-indigo-200"
                >
